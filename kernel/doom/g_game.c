...
{ 
	...
	endtime = I_GetTime ();
        ...
        // Calculate FPS as integer: (gametic * TICRATE * 100) / realtics for 2 decimal precision
        int fps_int = (gametic * TICRATE * 100) / realtics;
	...
	I_Error ("timed %i gametics in %i realtics (%i.%02i fps)",
                 gametic, realtics, fps_int / 100, fps_int % 100);
    } 
