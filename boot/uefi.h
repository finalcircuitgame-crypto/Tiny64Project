...
// Additional EFI status codes
#define EFI_LOAD_ERROR         (0x8000000000000001 | 0x1)
#define EFI_INVALID_PARAMETER  (0x8000000000000002 | 0x2)
#define EFI_UNSUPPORTED        (0x8000000000000003 | 0x3)
#define EFI_BAD_BUFFER_SIZE    (0x8000000000000004 | 0x4)
#define EFI_BUFFER_TOO_SMALL   (0x8000000000000005 | 0x5)
#define EFI_NOT_READY          (0x8000000000000006 | 0x6)
#define EFI_DEVICE_ERROR       (0x8000000000000007 | 0x7)
#define EFI_WRITE_PROTECTED    (0x8000000000000008 | 0x8)
#define EFI_OUT_OF_RESOURCES   (0x8000000000000009 | 0x9)
#define EFI_VOLUME_CORRUPTED   (0x800000000000000A | 0xA)
#define EFI_VOLUME_FULL        (0x800000000000000B | 0xB)
#define EFI_NO_MEDIA           (0x800000000000000C | 0xC)
#define EFI_MEDIA_CHANGED      (0x800000000000000D | 0xD)
#define EFI_NOT_FOUND          (0x800000000000000E | 0xE)
#define EFI_ACCESS_DENIED      (0x800000000000000F | 0xF)
#define EFI_NO_RESPONSE        (0x8000000000000010 | 0x10)
#define EFI_NO_MAPPING         (0x8000000000000011 | 0x11)
#define EFI_TIMEOUT            (0x8000000000000012 | 0x12)
#define EFI_NOT_STARTED        (0x8000000000000013 | 0x13)
#define EFI_ALREADY_STARTED    (0x8000000000000014 | 0x14)
#define EFI_ABORTED            (0x8000000000000015 | 0x15)
...
// Note: Advanced filesystem enumeration requires full UEFI headers
// For now, using basic single-filesystem detection
#endif
